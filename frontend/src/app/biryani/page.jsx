...
const Biryani = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const r = await fetch('/api/allproductapi/getBiryani');
  ...
  return (
    <div>
      ...
      <NextSeo
        title="Okhla Dastarkhan - Order Biryani from Your Favorite Shops"
        description="Order delicious Biryani from top-rated restaurants in Okhla with Okhla Dastarkhan. Enjoy fast delivery and convenient online ordering."
