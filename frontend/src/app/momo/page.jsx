...
const Momo = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const r = await fetch('/api/allproductapi/getMomo');
  ...
  return (
    <div>
      ...
      <NextSeo
        title="Order Momo from Your Favorite Restaurants - Okhla Dastarkhan"
        description="Order delicious Momo from top-rated restaurants in Okhla with Okhla Dastarkhan. Enjoy fast delivery and convenient online ordering."
