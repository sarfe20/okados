...
const Pizza = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const r = await fetch('/api/allproductapi/getPizza');
  ...
  return (
    <div>
      ...
      <NextSeo
        title="Order Pizza from Your Favorite Restaurants - Okhla Dastarkhan"
        description="Order delicious Pizza from top-rated restaurants in Okhla with Okhla Dastarkhan. Enjoy fast delivery and convenient online ordering."
