...
const Nihari = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const r = await fetch('/api/allproductapi/getNihari');
  ...
  return (
    <div>
      ...
      <NextSeo
        title="Order Nihari from Your Favorite Restaurants - Okhla Dastarkhan"
        description="Order delicious Nihari from top-rated restaurants in Okhla with Okhla Dastarkhan. Enjoy fast delivery and convenient online ordering."
